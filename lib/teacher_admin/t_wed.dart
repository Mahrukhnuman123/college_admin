...
class T_wednesday extends StatefulWidget {
  @override
  _T_wednesdayState createState() => _T_wednesdayState();
}

class _T_wednesdayState extends State<T_wednesday> {
  ...
  void _saveEntries() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        var snapshot = await FirebaseFirestore.instance.collection('T_wednesday').get();
        ...
        for (var entry in _entries) {
          await FirebaseFirestore.instance.collection('T_wednesday').add(entry);
        }
