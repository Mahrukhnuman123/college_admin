...
class  T_saturday extends StatefulWidget {
  @override
  _T_saturdayState createState() => _T_saturdayState();
}

class _T_saturdayState extends State<T_saturday> {
  ...
  void _saveEntries() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        var snapshot = await FirebaseFirestore.instance.collection('T_saturday').get();
        ...
        for (var entry in _entries) {
          await FirebaseFirestore.instance.collection(' T_saturday').add(entry);
        }
