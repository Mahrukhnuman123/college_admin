...
class T_sunday extends StatefulWidget {
  @override
  _T_sundayState createState() => _T_sundayState();
}

class _T_sundayState extends State<T_sunday> {
  ...
  void _saveEntries() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        var snapshot = await FirebaseFirestore.instance.collection('T_sunday').get();
        ...
        for (var entry in _entries) {
          await FirebaseFirestore.instance.collection(' T_sunday').add(entry);
        }
