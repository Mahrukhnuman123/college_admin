...
class T_tuesday extends StatefulWidget {
  @override
  _T_tuesdayState createState() => _T_tuesdayState();
}

class _T_tuesdayState extends State<T_tuesday> {
  ...
  void _saveEntries() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        var snapshot = await FirebaseFirestore.instance.collection('T_tuesday').get();
        ...
        for (var entry in _entries) {
          await FirebaseFirestore.instance.collection('T_tuesday').add(entry);
        }
